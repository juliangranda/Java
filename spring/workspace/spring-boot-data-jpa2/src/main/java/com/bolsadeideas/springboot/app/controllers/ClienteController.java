...
public class ClienteController {
	...
	public String listar(@RequestParam(name = "page", defaultValue = "0") int page, Model model,
		...
		// authentication de forma static para toda la aplicacion.
		...
		//otra manera para authentication usando request de HttpRequest(parametro del metodo)
	...
	private boolean hasRole(String role) {
		...
		/* authentication de forma manual ventaja uso de logger.info
