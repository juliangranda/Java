...
//        env.put("jboss.naming.client.ejb.context", true);
        try {
            ...
            service = (ServiceEjbRemote) ctx.lookup("ejb:/appejb-remote-jaas/ServiceEjb!org.juliangranda.webapp.ejb.service.ServiceEjbRemote?stateful");
            service2 = (ServiceEjbRemote) ctx.lookup("ejb:/appejb-remote-jaas/ServiceEjb!org.juliangranda.webapp.ejb.service.ServiceEjbRemote?stateful");
