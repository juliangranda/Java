...
public class Cliente {
    ...
    // un cliente con muchas direcciones
    //el primero relacionado con la clase(cliente)
    //el segundo relacionado con el atributo(direcciones)
    ...
    //se encarga de mantener la relacion entre Cliente y Factura, mappdBy es el atributo que se usa en factura.
    //orpahRemoval = se utiliza para que no quede alguna relacion huerfana haciendo que la tabla no contenga un valor null,
    // de no usarlo podria contener dicho valor null.
    //mappedBy se encarga de la relacion inversa entre cliente y factura en este caso.
