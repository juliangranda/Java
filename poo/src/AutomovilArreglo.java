...
public class AutomovilArreglo {
    public static void main(String[] args) {
        ...
        //error de java.lang.Comparable se soluciona en automovil
        //implementando la interfaz Comprable e implementando el metodo
        //compareTo.
        System.out.println(autos[0].getFabricante());
        Arrays.sort(autos);
