...
public class EjemploOrdenes {
    public static void main(String[] args) {
        ...
        orden1.addProducto(new Producto("Tencent","lol pirata",50));
        orden1.addProducto(new Producto("Supercell","castle clash",75));
        orden1.addProducto(new Producto("Epic Games", "sims",200));
        ...
        orden2.addProducto(new Producto("Kalley","Teclado",30));
        orden2.addProducto(new Producto("CZF", "Mouse Gaming", 20));
        orden2.addProducto(new Producto("lenovo", "pantalla", 80));
        ...
        orden3.addProducto(new Producto("Bubok","100 años de Soledad", 500));
        orden3.addProducto(new Producto("Planeta","Origen",60));
        orden3.addProducto(new Producto("Paidos","Habitos Atomicos",75));
