...
public class EjemploLocalDateTime {
    public static void main(String[] args) {
        ...
        fechaTiempo = LocalDateTime.of(2020, Month.DECEMBER, 24, 20,45,50);
        System.out.println("fechaTiempo = " + fechaTiempo);

        //año-mes-dia-Tiempo-hora-minuto-segundo-nanosegundo
        fechaTiempo = LocalDateTime.parse("2020-12-25T21:45:50.946482");
        System.out.println("fechaTiempo = " + fechaTiempo);
        ...
        int dias = fechaTiempo.getDayOfMonth();
